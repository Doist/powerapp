...
from .views import EditIntegrationView, authorize_evernote, authorize_evernote_done, sync_now, accept_webhook
...
urlpatterns = [
    ...
    url(r'^webhooks/accept/(?P<webhook_secret_key>\w+)/$', accept_webhook, name='accept_webhook')
]
